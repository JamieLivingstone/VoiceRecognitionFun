	...
	if (!('webkitSpeechRecognition' in window)) {
	    ...
	    (function () {
	        ...
	        recognition.onresult = function (event) {
	            ...
	            if (method in _commands2.default) {
	                console.log('true', method);
	                _commands2.default[method](command.toLowerCase());
	            } else {
	...
	exports.default = {
	    background: function background(color) {
	        if (color && color.indexOf(" ") === -1) {
	            ...
	            if (color === "random") {
	                color = (0, _index.randomColor)();
	            }
	            document.querySelector('.background').style.background = color;
	        }
	    },
	    video: function video(param) {
	        (0, _index.youtubeAPI)(param);
	    },
	    artist: function artist(name) {
	        (0, _index.artistSearch)(name);
	    },
	    top: function top() {
	        scrollTo(0, 0);
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	function artistSearch(name) {
	    ...
	    _axios2.default.get(url).then(function (data) {
	        var artist = data.data.artists.items[0];
	...
	function randomColor() {
	    ...
	    var colors = ['red', 'blue', 'green', 'pink', 'orange', 'cyan', 'purple', 'grey'];
